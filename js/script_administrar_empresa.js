...
function listarEmpresas(){
		...
		$.ajax({
			url:"./metodos_ajax/empresas/mostrar_empresa.php",
			method:"POST",
...
function modificar_empresa(){
  // alert("contador: "+$("#contadorFotos").val());
	...
	var formData = new FormData(document.getElementById("mantenedor_modificar_empresa"));
			...
			$.ajax({
				url:"./metodos_ajax/tb_empresas_relacionadas/editar_empresa.php",
				dataType: "html",
				type:'post',
				data: formData,
				cache: false,
...
function eliminarEmpresa(id){
	...
	swal({
			...
			function(isConfirm){
					if (isConfirm) {
			$.ajax({
				url:"./metodos_ajax/tb_empresas_relacionadas/eliminar_empresa.php?id_empresa="+id,
				method:"POST",
				success:function(respuesta){
					  alert(respuesta);
					 if(respuesta==1){
...
function listarImagenesEmpresa(){
			...
			$.ajax({
				url:"./metodos_ajax/tb_empresas_relacionadas/mostrar_imagenes_empresa.php?id_empresa="+id_empresa,
				method:"POST",
				success:function(respuesta){
